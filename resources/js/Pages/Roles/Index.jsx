            ...
            <div className="w-full p-2 sm:p-4 h-full flex flex-col">
                ...
                <div className="bg-white shadow-sm rounded-xl border border-gray-200 flex flex-col flex-1 overflow-hidden">
                    ...
                    <div className="p-4 sm:p-6 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-center gap-4 bg-gray-50/50">
                        ...
                        <PrimaryButton onClick={openAddModal} className="w-full sm:w-auto flex items-center justify-center gap-2">
                    ...
                    <div className="overflow-x-auto flex-1">
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-white">
                                <tr>
                                    <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Nama Role</th>
                                    <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Guard</th>
                                    <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Permissions (Hak Akses)</th>
                                                    ...
                                                    {role.permissions.length > 0 ? (
                                                        <>
                                                            {role.permissions.slice(0, 3).map((perm, idx) => (
                                                                <span key={idx} className="text-[10px] bg-green-50 text-green-700 px-2 py-0.5 rounded border border-green-200">
                                                                    {perm.name}
                                                                </span>
                                                            ))}
                    ...
                    <form onSubmit={handleSubmit} className="p-6">
                        <div className="flex items-center justify-between mb-6 border-b pb-4">
                            <h2 className="text-lg font-bold text-gray-900">
                                {isEditing ? 'Edit Role & Akses' : 'Tambah Role Baru'}
                            </h2>
                        ...
                        <div className="space-y-6">
                            {/* Nama Role */}
                            <div>
                                <InputLabel htmlFor="name" value="Nama Role (Jabatan)" />
                            ...
                            <div>
                                <InputLabel value="Hak Akses (Permissions)" className="mb-3" />
                                    ...
                                    {all_permissions.map((perm) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <span className={`text-sm capitalize select-none ${isChecked ? 'text-blue-800 font-medium' : 'text-gray-700'}`}>
                                ...
                                <p className="text-xs text-gray-500 mt-2 flex items-center gap-1">
                                    ...
                                    Centang fitur yang diperbolehkan untuk jabatan ini.
                                </p>
                            </div>
                        </div>
